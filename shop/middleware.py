...
class ContentSecurityPolicyMiddleware(MiddlewareMixin):
    ...
    def process_response(self, request, response):
        ...
        csp_policy = (
            ...
            f"'unsafe-inline'; "
            f"style-src 'self' {cloudfront_domain} https://fonts.googleapis.com https://cdn.jsdelivr.net https://stackpath.bootstrapcdn.com https://cdnjs.cloudflare.com 'unsafe-inline'; "
